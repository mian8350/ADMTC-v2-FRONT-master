...
@Component({
  selector: 'ms-school-compose-email-dialog',
  templateUrl: './school-compose-email-dialog.component.html',
  styleUrls: ['./school-compose-email-dialog.component.scss'],
})
export class SchoolComposeEmailDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<SchoolComposeEmailDialogComponent>,
