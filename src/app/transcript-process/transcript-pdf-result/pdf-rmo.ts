...
export class PdfRMO2020 {
  static RMO_2020 = '5cde777c5bdb94110a93e681'; // id for title "RMO 2020"
  ...
  static getUserInfo(student, result) {
    ...
    <p class="stud-detail-para"><span style="width:160px;display: inline-block;">Session
        :</span><b>${student.rncp_title._id === this.RMO_2020 ? '2020' : '2021'}</b></p>`;
  }
    ...
    if (result && result.block_of_competence_conditions && pdfData) {
      ...
      table =
        ...
        `</tbody>
            <tfoot>
              <tr>
                  <td colspan="4" class="header-card-rmo" style="float: unset;border: 1px solid #17365d;">
                      Décision :  ${
                        studentTranscript &&
  ...
  static getFooter(journalText) {
    ...
    <div style="display: block; text-align: center; margin-top: 40px">
      <img style="max-height: 80px" src="${ImageBase64.C32020Stamp}">
    </div>
    <div style="width: 90%; margin: 5px auto 30px; text-align: center; position: fixed; bottom: 0; font-weight: 100">
      <div style="font-size:9px; display:block">
        <b>Certification Professionnelle - Responsable Marketing Opérationnel</b>
      </div>
      <div style="font-size:9px; display:block">
        ${journalText}
      </div>
