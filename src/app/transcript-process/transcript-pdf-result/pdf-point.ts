...
export class PdfPoint {
  ...
  static computeFirstBodyPart(expertise, student, result) {
    ...
    if (expertise && expertise.block_of_competence_conditions.length) {
      for (const expert of expertise.block_of_competence_conditions) {
  ...
  static computeSecondBodyPart(expertise, result, titleId, pdfData) {
    ...
    <table style="width: 100%; margin-bottom: 30px;">
      <tr>
        ...
        <td width="25%" style="text-align: center; border: 1px solid black">${
          pdfData.parameter_obtained_id ? pdfData.parameter_obtained_id.condition_name : ''
        }</td>
      </tr>
    </table>
