...
export class PdfCDCM2020 {
  static computerRDCPDF(student: any, result, expertise, journalText?, pdfData?, studentTranscript?) {
    const cpeaPdf = `
            ...
            <div style="width:90%; margin: 0 auto; display:block; text-align:center;font-size: 12px;">
              <b>Certification professionnelle « Chargé(e) de développement commercial et marketing » de Niveau 6<b/>
            </div>
  ...
  static getFooter(student, journalText) {
    return `
    <div style="display: block; text-align: center; margin-top: 0; height: 100px">
      <img style="max-height: 80px" src="${ImageBase64.cdcmStamp}">
    </div>
    <div style="width: 90%; margin: 5px auto 30px; text-align: center; position: fixed; bottom: 0; font-weight: 100">
      ...
      <div style="font-size:11px; display:block">
        EFIP GROUPE ESCCOT – 29 avenue des Peupliers – 35510 CESSON SEVIGNE
      </div>
    </div>`;
  }
