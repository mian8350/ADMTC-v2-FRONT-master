    ...
    return `
      <div style="display:flex; justify-content:center; text-align:center; width:100%;">
        <div style="display:inline-block;margin:0">
          <img src="${ImageBase64.rgpStamp}" style="max-height:80px">
        </div>
        <div style="display:inline-block;margin:0px -15px">
          <img src="${ImageBase64.rgpSign}" style="max-height:80px">
        </div>
      </div>
      <div style="width: 90%; text-align: center; position: fixed; bottom: 0; margin-bottom: 10px">
        ...
        <div style="font-size:11px; display:block">
          ISCG - 13 rue de Cîteaux - 75012 PARIS
        </div>
      </div>
    `;
  }
