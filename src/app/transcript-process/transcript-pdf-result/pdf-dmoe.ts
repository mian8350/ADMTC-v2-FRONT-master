...
export class PdfDMOE2021 {
  static DMOE2020 = '5b3dfce527a41d7a83375b65'; // id for title "DMOE 2020"
  static DMOEPIGIER2020 = '5c6533c86df34f18eb3ab99b'; // id for title "DMOE PIGIER 2020"

  static computerRDCPDF(student: any, result, expertise, journalText, pdfData, studentTranscript?) {

    const cpeaPdf = `
            <div class="main-container-dmoe">
            ...
            <div style="width:90%;  margin: 0 auto; display:block; text-align:center;font-size: 12px;">
            ...
            <div class="result-container" style="padding: 0px 7px !important;margin: 0 !important;">
              ...
              ${this.getFooter(journalText, student)}
            </div>
          </div>
          `;
    return cpeaPdf;
  ...
  static getUserInfo(student, result) {
    return `
        ...
        <p class="stud-detail-para"><span style="width:160px;display: inline-block;">Session
            :</span><b>${
              student.rncp_title._id === this.DMOE2020 ||
              student.rncp_title._id === this.DMOEPIGIER2020
              ? '2020'
              : '2021'
            }</b></p>`;
  }
    ...
    if (result && result.block_of_competence_conditions && pdfData) {
      ...
      table =
        ...
        `</tbody>
            <tfoot>
              <tr>
                  <td colspan="4" class="header-card-dmoe" style="float: unset;border: 1px solid #17365d;">
                      Décision :  ${
                        studentTranscript &&
  ...
  static getFooter(journalText, student) {
    return `
    <div style="display: block; text-align: center;">
      <img style="max-height: 70px" src="${ImageBase64.C32020Stamp}">
    </div>
    <div style="width: 90%; margin: 5px 0px 2px 0px; text-align: center; position: fixed; bottom: 0px !important; font-weight: 100">
      <span style="font-size:9px; display:block; margin: 0px !important; padding: 0px !important">
        <b>Certification Professionnelle - Dirigeant Manager Opérationnel d'Entreprise</b>
      </span>
      <span style="font-size:9px; display:block; margin: 0px !important; padding: 0px !important">
        ${journalText}
      </span>
      <span style="font-size:9px; display:block; margin: 0px !important; padding: 0px !important">
        C3 INSTITUTE - 101 rue de la Fontaine Grelot - 92160 ANTONY
      </span>
    </div>`;
  }
