...
import { STUDENTSTYLES } from './students-pdf-style';

@Component({
  selector: 'ms-pdf-student-grand-oral',
  templateUrl: './pdf-student-grand-oral.component.html',
  styleUrls: ['./pdf-student-grand-oral.component.scss'],
})
export class PdfStudentGrandOralComponent implements OnInit, AfterViewInit {
  ...
  generatePDFStudents() {
    const fileDoc = document.getElementById('grand-oral-student').innerHTML;
    let html = STUDENTSTYLES;
    html = html + fileDoc;
    html = STYLE + html;
    return html;
  }
