...
@Component({
  selector: 'ms-upload-presentation-document-task',
  templateUrl: './upload-presentation-document-task.component.html',
  styleUrls: ['./upload-presentation-document-task.component.scss'],
})
export class UploadPresentationDocumentTaskComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<UploadPresentationDocumentTaskComponent>,
  ...
  createAcadDoc() {
    ...
    payload.type_of_document = 'student_upload_grand_oral_presentation';
    payload.document_generation_type = 'student_upload_grand_oral_presentation';
