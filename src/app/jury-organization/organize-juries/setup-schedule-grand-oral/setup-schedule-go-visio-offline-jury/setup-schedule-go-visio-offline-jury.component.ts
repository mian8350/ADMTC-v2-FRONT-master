...
@Component({
  selector: 'ms-setup-schedule-go-visio-offline-jury',
  templateUrl: './setup-schedule-go-visio-offline-jury.component.html',
  styleUrls: ['./setup-schedule-go-visio-offline-jury.component.scss'],
  providers: [ParseUtcToLocalPipe, ParseLocalToUtcPipe],
})
export class SetupScheduleGoVisioOfflineJuryComponent implements OnInit, AfterViewInit, OnDestroy {
      ...
      .subscribe(
        (schedules) => {
          ...
          if (schedules) {
            ...
            if (this.allSelected && this.dataSource.data && this.dataSource.data.length) {
              this.selection.clear();
