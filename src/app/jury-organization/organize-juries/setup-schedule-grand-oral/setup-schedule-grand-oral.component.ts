...
@Component({
  selector: 'ms-setup-schedule-grand-oral',
  templateUrl: './setup-schedule-grand-oral.component.html',
  styleUrls: ['./setup-schedule-grand-oral.component.scss'],
})
export class SetupScheduleGrandOralComponent implements OnInit, OnDestroy {
