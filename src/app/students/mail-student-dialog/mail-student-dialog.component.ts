...
@Component({
  selector: 'ms-mail-student-dialog',
  templateUrl: './mail-student-dialog.component.html',
  styleUrls: ['./mail-student-dialog.component.scss'],
})
export class MailStudentDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<MailStudentDialogComponent>,
  ...
  closeDialog(): void {
    swal
      .fire({
        ...
        footer: `<span style="margin-left: auto">DRAFT</span>`,
        type: 'warning',
    ...
    if (formValues.subject !== '' || (formValues.message !== '' && formValues.message !== undefined)) {
      ...
      this.subs.sink = this.mailboxService.createMail(this.mailData).subscribe((data: any) => {
        swal.fire({
          ...
          text: '',
          footer: `<span style="margin-left: auto">MESSAGES.DRAFTMSG</span>`,
