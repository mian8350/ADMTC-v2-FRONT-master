...
@Component({
  selector: 'ms-derogation-diploma-dialog',
  templateUrl: './derogation-diploma-dialog.component.html',
  styleUrls: ['./derogation-diploma-dialog.component.scss']
})
export class DerogationDiplomaDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<DerogationDiplomaDialogComponent>,
  ...
  ngOnInit() {
    ...
    if (this.parentData.type === 'edit' && this.parentData.derogation) {
      this.uploadDocForm.patchValue(this.parentData.derogation);
    }
  }
